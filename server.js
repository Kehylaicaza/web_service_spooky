...
app.put('/updateUser',(req,res)=>{
    ...
    client.connect(function(err) {
        ...
        client.query("UPDATE usuario SET name='"+req.body.name+"',  pass='"+req.body.pass+"',  usuario='"+req.body.usuario+"', sexo='"+req.body.sexo+"',edad='"+req.body.edad+"' WHERE id='" + id + "';", function(err, result) {
